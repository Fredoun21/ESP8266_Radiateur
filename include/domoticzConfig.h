...
#define WM_PASSWORD "password"        // mot de passe Wifimanager
#endif
...
#define MQTT_ID "ESP55_AUXENCE_RADIATEUR" // Nom du client sur MQTT
...
#define MQTT_ID "ESP57_MAXIMILIEN_RADIATEUR" // Nom du client sur MQTT
